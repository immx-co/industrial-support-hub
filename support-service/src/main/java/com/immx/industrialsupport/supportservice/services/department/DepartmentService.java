...
public class DepartmentService implements IDepartmentService {
    ...
    public Department getById(UUID organizationId, UUID departmentId) {
        ...
        Optional<Department> department = departmentRepository.findByIdAndOrganizationId(organizationId, departmentId);
    ...
    @Override
    public Department create(UUID organizationId, CreateDepartmentRequest createDepartmentRequest) {
        Optional<Organization> organization = organizationRepository.findById(organizationId);
